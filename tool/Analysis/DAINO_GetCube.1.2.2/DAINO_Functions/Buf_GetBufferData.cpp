         ...
         switch ( Package )
         {
            case 1:
               ...
               for (int i=0; i<LoopWidth[0]; i++)                    {  ii  = i + Disp[t][0];
                  ...
                  ID = NSpecies * ( P*LoopWidth[0]*LoopWidth[1]*LoopWidth[2] + k*LoopWidth[0]*LoopWidth[1] + 
                     ...
                     SendBuffer[t][ID+v] = patch.ptr[lv][PID]->fluid[v][kk][jj][ii];
            ...
            case 2:
               ...
               for (int i=0; i<LoopWidth[0]; i++)                    {  ii  = i + Disp[t][0];
                  ...
                  SendBuffer[t][ID] = patch.ptr[lv][PID]->pot[kk][jj][ii];
...
/*
            case 3:
               ...
               for (int i=0; i<LoopWidth[0]; i++)                    {  ii  = i + Disp[t][0];
                  ...
                  SendBuffer[t][ID] = patch.ptr[lv][PID]->fluid[kk][jj][ii][0];
...
//    copy the data in the RecvBuffer back to the patch.ptr pointer
      for (int t=0; t<2; t++)
      {
         sib = TargetSib[s+t];
         ...
         switch ( Package )
         {
            case 1:
               ...
               for (int i=0; i<LoopWidth[0]; i++)                    {  ii  = i + Disp[!t][0];
                  ...
                  ID = NSpecies * ( P*LoopWidth[0]*LoopWidth[1]*LoopWidth[2] + k*LoopWidth[0]*LoopWidth[1] + 
                     ...
                     patch.ptr[lv][PID]->fluid[v][kk][jj][ii] = RecvBuffer[t][ID+v];
            ...
            case 2:
               ...
               for (int i=0; i<LoopWidth[0]; i++)                    {  ii  = i + Disp[!t][0];
                  ...
                  patch.ptr[lv][PID]->pot[kk][jj][ii] = RecvBuffer[t][ID];
...
/*               
            case 3:
               ...
               for (int i=0; i<LoopWidth[0]; i++)                    {  ii  = i + Disp[!t][0];
                  ...
                  patch.ptr[lv][PID]->fluid[kk][jj][ii][0] = RecvBuffer[t][ID];
