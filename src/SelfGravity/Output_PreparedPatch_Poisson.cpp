...
// Description :  Output the density/potential of a single patch plus its ghost zones prepared by the functions
//                "Poi_Prepare_Rho/Poi_Prepare_Pot"
//
// Note        :  For "TComp == 0", this function should be placed after invoking "Prepare_PatchGroupData" in 
//                the function "Poi_Prepare_Rho". For "TComp == 1", this function should be placed in the end
//                of the function "Poi_Prepare_Pot".
//                
//                Example:
//                const int TLv   = 1;
//                const int TPID  = 12;
...
//    begin to output the prepared data
      ...
      char FileName[100];
      sprintf( FileName, "PrePatch_Poisson_r%d_lv%d_p%d", DAINO_RANK, TLv, TPID );
      if ( comment != NULL )    
      {
         strcat( FileName, "_" );
